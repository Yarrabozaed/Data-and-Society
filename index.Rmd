...
The COVID-19 pandemic has disproportionately impacted low-income individuals, resulting in significant job losses around the world. This paper examines the relationship between the responses to the pandemic in the United States and the impact of such responses on the low-income job market. We examine a set of relevant variables that are correlated to the loss of low-income jobs and use such variables to create a predictive model using principal component analysis.

By shedding light on the unique experiences and hardships faced by low-income individuals affected by job loss, this abstract aims to inform policymakers and organizations about the importance of addressing equity and inclusivity in employment strategies. 
...
The data was collected by the Bureau of Labor Statistics, which was released in September 2022. It represents the average annual private industry mean wages per employee in the United States by state in 2021. It includes all fifty states’ average salary in 2011 in U.S. dollars. Additionally, average salary for District of Columbia and United States are included, which are not accounted for in the variable’s statistical analysis.  
