...
The data was collected by the Bureau of Labor Statistics, which was released in September 2022. It represents the average annual private industry mean wages per employee in the United States by state in 2021. It includes all fifty states’ average salary in 2021 in U.S. dollars. Additionally, average salary for District of Columbia and United States are included, which are not accounted for in the variable’s statistical analysis.  
...
remote_work_2021 <- read_excel("remote_work_2021.xlsx")
...
ggplot(annualsalary_map) +
  geom_sf(aes(fill = Avg_Annual_Wage)) +
  scale_fill_continuous(low = "red", high = "green") + 
  my_map_theme() +
  labs(title = "Average Annual Wage Across States in 2021") +
  theme(plot.title = element_text(hjust = -2.5, size = 20)) +
...
#add colors
my_colors <- c("#d0d1e6","#a6bddb","#67a9cf","#1c9099","#016c59",
                        "white","#f6eff7")
#initial map
ggplot(mapdata2) +
  geom_sf(aes(fill= mar), color = "black") +
