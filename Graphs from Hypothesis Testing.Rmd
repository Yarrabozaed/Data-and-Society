...
states <- st_as_sf(fifty_states, coords =c("long", "lat"), crs = 4326)
...
my_cutpoints1 <- c(40, 50, 65, 70, 90, 100)
my_labels1 <- c("40 - 50%", "50 - 65%", "65 - 70%", "70 - 90%", "90% +")

choro$mar1 <- cut(choro$Percent_total_pop_with_completed_primary_series, breaks = my_cutpoints1, labels = my_labels1)

#add colors
my_colors1 <- c("#7fcdbb","#41b6c4","#1d91c0","#225ea8","#0c2c84",
                        "white","#c7e9b4")
